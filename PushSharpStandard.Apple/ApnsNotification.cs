...
namespace PushSharpStandard.Apple
{
    public class ApnsNotification : INotification
    {
        ...
        public ApnsNotification() : this(string.Empty, string.Empty)
        {
        }

        public ApnsNotification(string deviceToken) : this(deviceToken, string.Empty)
        {
        }
